...
const Header = () => { 
  ...
  return (
    <>
          <section className='container-headerbackground'>
            <div className='bg-img-container'>
              <img height='724px' className='header-bg' src={headerbg} alt="bg-la-palacio" />
            </div>
              ...
              {open === true &&
                <div className='menu-navBar'>
                  ...
                  <div className='links-container'>
                    <Link onClick={handleClickClose} className='links-sub-menu-open' to='/'>Home</Link>
                    <Link onClick={handleClickClose} className='links-menu-open' to='/store'>Libros</Link>
                    <div className='sub-links-container'>
                      <Link onClick={handleClickClose} className='links-sub-menu-open' to='/store'>Usados</Link>
                      <Link onClick={handleClickClose} className='links-sub-menu-open' to='/store'>Recomendados</Link>
                      <Link onClick={handleClickClose} className='links-sub-menu-open' to='/store'>Novedades</Link>
                    </div>
                    <Link onClick={handleClickClose} className='links-menu-open' to='/writers'>Escritorxs</Link>
                    <Link onClick={handleClickClose} className='links-menu-open' to='/contact'>Nosotrxs</Link>
                    <Link onClick={handleClickClose} className='links-menu-open' to='/store'>Tienda</Link>
                    <Link onClick={handleClickClose} className='links-menu-open' to='/contact'>Contacto</Link>
                  </div>
                </div>
              }
                ...
                {openQueer === true &&
                  <div className='queer-container'>
                    <div className='queer-open-bar'>
                      ...
                      <p className='word-close' onClick={handleClickQueerClose} >Queer y orgullosxs</p>
                    </div>
